...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class shop.terminal.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class shop.terminal.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class shop.terminal.api.** {
    <init>(...);
