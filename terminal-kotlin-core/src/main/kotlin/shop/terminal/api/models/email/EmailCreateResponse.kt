...
@NoAutoDetect
class EmailCreateResponse @JsonCreator private constructor(
    ...
    fun validate(): EmailCreateResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(emailCreateResponse: EmailCreateResponse) =
            apply {
    ...
    override fun toString() = "EmailCreateResponse{data=$data, additionalProperties=$additionalProperties}"
}
