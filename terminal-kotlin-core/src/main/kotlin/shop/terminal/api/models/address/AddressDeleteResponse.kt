...
@NoAutoDetect
class AddressDeleteResponse @JsonCreator private constructor(
    ...
    fun validate(): AddressDeleteResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(addressDeleteResponse: AddressDeleteResponse) =
            apply {
                data = addressDeleteResponse.data
                additionalProperties = addressDeleteResponse.additionalProperties.toMutableMap()
            }
    ...
    override fun toString() = "AddressDeleteResponse{data=$data, additionalProperties=$additionalProperties}"
}
