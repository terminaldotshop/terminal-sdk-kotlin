...
private constructor(
    private val data: JsonField<Product>,
    private val additionalProperties: MutableMap<String, JsonValue>,
) {

    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<Product> = JsonMissing.of()
    ...
    /** A builder for [ProductGetResponse]. */
    class Builder internal constructor() {
         ...
         *
         * You should usually call [Builder.data] with a well-typed [Product] value instead. This
        ...
        /**
         * Returns an immutable instance of [ProductGetResponse].
         *
        ...
        fun build(): ProductGetResponse =
            ProductGetResponse(checkRequired("data", data), additionalProperties.toMutableMap())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ProductGetResponse &&
            data == other.data &&
