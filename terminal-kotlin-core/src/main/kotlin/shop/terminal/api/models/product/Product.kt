...
class Product @JsonCreator private constructor(
    ...
    @JsonProperty("variants") @ExcludeMissing private val variants: JsonField<List<ProductVariant>> = JsonMissing.of(),
    ...
    class Builder internal constructor() {
        ...
        /** List of variants of the product. */
        fun variants(variants: JsonField<List<ProductVariant>>) =
            apply {
        ...
        fun addVariant(variant: ProductVariant) =
            apply {
                variants = (variants ?: JsonField.of(mutableListOf())).also {
    ...
    class Subscription @JsonCreator private constructor(
        ...
        /**
         * An enum containing [Subscription]'s known values, as well as an [_UNKNOWN]
         * member.
         *
        ...
        enum class Value {
            ...
            REQUIRED,
            /**
             * An enum member indicating that [Subscription] was instantiated with an unknown
             * value.
             */
            _UNKNOWN,
        }
    ...
    /** Tags for the product. */
    @NoAutoDetect
    class Tags @JsonCreator private constructor(
        ...
        @JsonProperty("featured") @ExcludeMissing private val featured: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("market_eu") @ExcludeMissing private val marketEu: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("market_na") @ExcludeMissing private val marketNa: JsonField<Boolean> = JsonMissing.of(),
        ...
        @ExcludeMissing
        fun _featured(): JsonField<Boolean> = featured

        @JsonProperty("market_eu")
        @ExcludeMissing
        fun _marketEu(): JsonField<Boolean> = marketEu

        @JsonProperty("market_na")
        @ExcludeMissing
        fun _marketNa(): JsonField<Boolean> = marketNa
        ...
        class Builder internal constructor() {
            ...
            fun featured(featured: JsonField<Boolean>) =
                apply {
            ...
            fun marketEu(marketEu: JsonField<Boolean>) =
                apply {
                    this.marketEu = marketEu
                }

            fun marketNa(marketNa: Boolean) = marketNa(JsonField.of(marketNa))

            fun marketNa(marketNa: JsonField<Boolean>) =
                apply {
                    this.marketNa = marketNa
                }
        ...
        override fun toString() = "Tags{app=$app, color=$color, featured=$featured, marketEu=$marketEu, marketNa=$marketNa, type=$type, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() = "Product{id=$id, description=$description, name=$name, variants=$variants, order=$order, subscription=$subscription, tags=$tags, additionalProperties=$additionalProperties}"
}
