...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): OrderListParams =
            OrderListParams(additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "OrderListParams{additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
