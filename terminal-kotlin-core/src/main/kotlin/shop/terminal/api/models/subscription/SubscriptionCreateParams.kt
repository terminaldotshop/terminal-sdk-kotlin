...
class SubscriptionCreateParams private constructor(
    ...
    fun _additionalBodyProperties(): Map<String, JsonValue> = subscription?._additionalProperties() ?: immutableEmptyMap()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(subscriptionCreateParams: SubscriptionCreateParams) =
            apply {
    ...
    override fun toString() = "SubscriptionCreateParams{subscription=$subscription, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
