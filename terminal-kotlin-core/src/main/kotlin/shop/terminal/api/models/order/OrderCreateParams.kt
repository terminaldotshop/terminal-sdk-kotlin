...
class OrderCreateParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        @JsonProperty("variants") @ExcludeMissing private val variants: JsonField<Variants> = JsonMissing.of(),
        ...
        @ExcludeMissing
        fun _variants(): JsonField<Variants> = variants
        ...
        class Builder internal constructor() {
            ...
            /** Product variants to include in the order, along with their quantities. */
            fun variants(variants: JsonField<Variants>) =
                apply {
        ...
        override fun toString() = "Body{addressId=$addressId, cardId=$cardId, variants=$variants, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(orderCreateParams: OrderCreateParams) =
            apply {
        ...
        /** Product variants to include in the order, along with their quantities. */
        fun variants(variants: Variants) =
            apply {
    ...
    /** Product variants to include in the order, along with their quantities. */
    @NoAutoDetect
    class Variants @JsonCreator private constructor(
        @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
        ...
        class Builder internal constructor() {
            ...
            internal fun from(variants: Variants) =
                apply {
    ...
    override fun toString() = "OrderCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
