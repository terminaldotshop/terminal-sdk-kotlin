...
class OrderListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(orderListParams: OrderListParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OrderListParams && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "OrderListParams{additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
