...
private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<Cart> = JsonMissing.of()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CartGetResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(cartGetResponse: CartGetResponse) = apply {
            data = cartGetResponse.data
            additionalProperties = cartGetResponse.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.data] with a well-typed [Cart] value instead. This
        ...
        /**
         * Returns an immutable instance of [CartGetResponse].
         *
         ...
         */
        fun build(): CartGetResponse =
            CartGetResponse(checkRequired("data", data), additionalProperties.toMutableMap())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CartGetResponse &&
            data == other.data &&
