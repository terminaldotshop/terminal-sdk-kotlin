...
class Address @JsonCreator private constructor(
    ...
    override fun toString() = "Address{id=$id, city=$city, country=$country, name=$name, street1=$street1, zip=$zip, phone=$phone, province=$province, street2=$street2, additionalProperties=$additionalProperties}"
}
