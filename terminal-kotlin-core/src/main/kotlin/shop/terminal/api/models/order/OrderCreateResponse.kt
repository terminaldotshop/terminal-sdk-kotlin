...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [OrderCreateResponse].
         *
        ...
        fun build(): OrderCreateResponse =
            OrderCreateResponse(checkRequired("data", data), additionalProperties.toMutableMap())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OrderCreateResponse &&
            data == other.data &&
