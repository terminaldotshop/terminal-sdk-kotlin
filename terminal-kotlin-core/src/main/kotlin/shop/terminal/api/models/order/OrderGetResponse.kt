...
private constructor(
    ...
    /** A builder for [OrderGetResponse]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [OrderGetResponse].
         *
        ...
        fun build(): OrderGetResponse =
            OrderGetResponse(checkRequired("data", data), additionalProperties.toMutableMap())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OrderGetResponse &&
            data == other.data &&
