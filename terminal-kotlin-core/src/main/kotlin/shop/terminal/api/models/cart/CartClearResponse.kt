...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CartClearResponse].
         *
    ...
    /** A builder for [CartClearResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<Data>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(cartClearResponse: CartClearResponse) = apply {
            data = cartClearResponse.data
            additionalProperties = cartClearResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CartClearResponse].
         *
         ...
         */
        fun build(): CartClearResponse =
            CartClearResponse(checkRequired("data", data), additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): CartClearResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CartClearResponse && data == other.data && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "CartClearResponse{data=$data, additionalProperties=$additionalProperties}"
}
