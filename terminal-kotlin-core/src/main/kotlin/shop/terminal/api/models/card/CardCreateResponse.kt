...
@NoAutoDetect
class CardCreateResponse @JsonCreator private constructor(
    ...
    fun validate(): CardCreateResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(cardCreateResponse: CardCreateResponse) =
            apply {
    ...
    override fun toString() = "CardCreateResponse{data=$data, additionalProperties=$additionalProperties}"
}
