...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): AddressListParams =
            AddressListParams(additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "AddressListParams{additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
