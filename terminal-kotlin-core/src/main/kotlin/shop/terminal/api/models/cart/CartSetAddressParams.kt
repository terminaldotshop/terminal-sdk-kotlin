...
class CartSetAddressParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        override fun toString() = "Body{addressId=$addressId, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(cartSetAddressParams: CartSetAddressParams) =
            apply {
    ...
    override fun toString() = "CartSetAddressParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
