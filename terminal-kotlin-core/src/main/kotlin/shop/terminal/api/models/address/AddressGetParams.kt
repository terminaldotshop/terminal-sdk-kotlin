...
class AddressGetParams private constructor(
    ...
    /** A builder for [AddressGetParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        internal fun from(addressGetParams: AddressGetParams) =
            apply {
                id = addressGetParams.id
                additionalHeaders = addressGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = addressGetParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun toString() = "AddressGetParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
