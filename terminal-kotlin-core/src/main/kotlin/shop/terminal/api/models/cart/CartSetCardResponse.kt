...
@NoAutoDetect
class CartSetCardResponse @JsonCreator private constructor(
    ...
    fun validate(): CartSetCardResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(cartSetCardResponse: CartSetCardResponse) =
            apply {
    ...
    override fun toString() = "CartSetCardResponse{data=$data, additionalProperties=$additionalProperties}"
}
