...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CartSetCardResponse].
         *
    ...
    /** A builder for [CartSetCardResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<Data>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(cartSetCardResponse: CartSetCardResponse) = apply {
            data = cartSetCardResponse.data
            additionalProperties = cartSetCardResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CartSetCardResponse].
         *
         ...
         */
        fun build(): CartSetCardResponse =
            CartSetCardResponse(checkRequired("data", data), additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): CartSetCardResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CartSetCardResponse && data == other.data && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "CartSetCardResponse{data=$data, additionalProperties=$additionalProperties}"
}
