 ...
 * user.
 */
class CardCollectParams private constructor(
    ...
    companion object {
        ...
        fun none(): CardCollectParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [CardCollectParams]. */
        fun builder() = Builder()
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(cardCollectParams: CardCollectParams) =
            apply {
    ...
    override fun toString() = "CardCollectParams{additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
