...
@NoAutoDetect
class CartRemoveGiftCardResponse
@JsonCreator
private constructor(
    ...
    fun validate(): CartRemoveGiftCardResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CartRemoveGiftCardResponse].
         *
    ...
    /** A builder for [CartRemoveGiftCardResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<Data>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(cartRemoveGiftCardResponse: CartRemoveGiftCardResponse) = apply {
            data = cartRemoveGiftCardResponse.data
            additionalProperties = cartRemoveGiftCardResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): CartRemoveGiftCardResponse =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CartRemoveGiftCardResponse && data == other.data && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "CartRemoveGiftCardResponse{data=$data, additionalProperties=$additionalProperties}"
}
