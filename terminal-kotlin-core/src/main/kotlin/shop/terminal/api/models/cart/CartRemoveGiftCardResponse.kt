...
@NoAutoDetect
class CartRemoveGiftCardResponse @JsonCreator private constructor(
    ...
    fun validate(): CartRemoveGiftCardResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(cartRemoveGiftCardResponse: CartRemoveGiftCardResponse) =
            apply {
    ...
    override fun toString() = "CartRemoveGiftCardResponse{data=$data, additionalProperties=$additionalProperties}"
}
