...
class TokenListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(tokenListParams: TokenListParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is TokenListParams && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "TokenListParams{additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
