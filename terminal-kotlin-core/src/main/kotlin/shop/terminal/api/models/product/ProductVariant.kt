...
@NoAutoDetect
class ProductVariant @JsonCreator private constructor(
    ...
    @JsonProperty("price")
    @ExcludeMissing
    fun _price(): JsonField<Long> = price
    ...
    class Builder internal constructor() {
        ...
        internal fun from(productVariant: ProductVariant) =
            apply {
        ...
        /** Price of the product variant in cents (USD). */
        fun price(price: JsonField<Long>) =
            apply {
                this.price = price
            }
    ...
    override fun toString() = "ProductVariant{id=$id, name=$name, price=$price, additionalProperties=$additionalProperties}"
}
