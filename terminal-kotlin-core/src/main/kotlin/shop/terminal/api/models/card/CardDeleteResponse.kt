...
@NoAutoDetect
class CardDeleteResponse @JsonCreator private constructor(
    ...
    fun validate(): CardDeleteResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(cardDeleteResponse: CardDeleteResponse) =
            apply {
    ...
    override fun toString() = "CardDeleteResponse{data=$data, additionalProperties=$additionalProperties}"
}
