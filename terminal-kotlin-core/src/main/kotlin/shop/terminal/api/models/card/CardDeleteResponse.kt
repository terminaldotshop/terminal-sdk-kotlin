...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CardDeleteResponse].
         *
    ...
    /** A builder for [CardDeleteResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<Data>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(cardDeleteResponse: CardDeleteResponse) = apply {
            data = cardDeleteResponse.data
            additionalProperties = cardDeleteResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CardDeleteResponse].
         *
         ...
         */
        fun build(): CardDeleteResponse =
            CardDeleteResponse(checkRequired("data", data), additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): CardDeleteResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CardDeleteResponse && data == other.data && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "CardDeleteResponse{data=$data, additionalProperties=$additionalProperties}"
}
