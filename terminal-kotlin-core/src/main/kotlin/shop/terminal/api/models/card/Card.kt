...
class Card @JsonCreator private constructor(
    ...
    @JsonProperty("expiration") @ExcludeMissing private val expiration: JsonField<Expiration> = JsonMissing.of(),
    ...
    @JsonProperty("brand")
    @ExcludeMissing
    fun _brand(): JsonField<String> = brand
    ...
    class Builder internal constructor() {
        ...
        /** Brand of the card. */
        fun brand(brand: JsonField<String>) =
            apply {
                this.brand = brand
            }
        ...
        /** Expiration of the card. */
        fun expiration(expiration: JsonField<Expiration>) =
            apply {
    ...
    /** Expiration of the card. */
    @NoAutoDetect
    class Expiration @JsonCreator private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(expiration: Expiration) =
                apply {
        ...
        override fun toString() = "Expiration{month=$month, year=$year, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() = "Card{id=$id, brand=$brand, expiration=$expiration, last4=$last4, additionalProperties=$additionalProperties}"
}
