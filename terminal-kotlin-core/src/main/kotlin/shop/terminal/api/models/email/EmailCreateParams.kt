...
class EmailCreateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(emailCreateParams: EmailCreateParams) =
            apply {
    ...
    override fun toString() = "EmailCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
