...
@NoAutoDetect
class CartSetAddressResponse @JsonCreator private constructor(
    ...
    fun validate(): CartSetAddressResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(cartSetAddressResponse: CartSetAddressResponse) =
            apply {
    ...
    override fun toString() = "CartSetAddressResponse{data=$data, additionalProperties=$additionalProperties}"
}
