...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CartSetAddressResponse].
         *
    ...
    /** A builder for [CartSetAddressResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<Data>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(cartSetAddressResponse: CartSetAddressResponse) = apply {
            data = cartSetAddressResponse.data
            additionalProperties = cartSetAddressResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CartSetAddressResponse].
         *
         ...
         */
        fun build(): CartSetAddressResponse =
            CartSetAddressResponse(checkRequired("data", data), additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): CartSetAddressResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CartSetAddressResponse && data == other.data && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "CartSetAddressResponse{data=$data, additionalProperties=$additionalProperties}"
}
