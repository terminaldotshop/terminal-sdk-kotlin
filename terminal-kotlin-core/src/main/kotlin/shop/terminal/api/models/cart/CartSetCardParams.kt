...
class CartSetCardParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(cartSetCardParams: CartSetCardParams) =
            apply {
    ...
    override fun toString() = "CartSetCardParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
