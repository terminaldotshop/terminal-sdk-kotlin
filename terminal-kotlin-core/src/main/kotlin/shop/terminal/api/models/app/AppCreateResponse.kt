...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [AppCreateResponse].
         *
        ...
        fun build(): AppCreateResponse =
            AppCreateResponse(checkRequired("data", data), additionalProperties.toMutableMap())
    }
    ...
    private constructor(
        ...
        internal fun validity(): Int =
            (if (id.asKnown() == null) 0 else 1) + (if (secret.asKnown() == null) 0 else 1)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AppCreateResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
