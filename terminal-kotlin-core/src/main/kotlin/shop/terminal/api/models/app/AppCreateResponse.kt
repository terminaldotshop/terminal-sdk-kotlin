...
@NoAutoDetect
class AppCreateResponse @JsonCreator private constructor(
    ...
    fun validate(): AppCreateResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(appCreateResponse: AppCreateResponse) =
            apply {
                data = appCreateResponse.data
                additionalProperties = appCreateResponse.additionalProperties.toMutableMap()
            }
    ...
    class Data @JsonCreator private constructor(
        ...
        override fun toString() = "Data{id=$id, secret=$secret, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() = "AppCreateResponse{data=$data, additionalProperties=$additionalProperties}"
}
