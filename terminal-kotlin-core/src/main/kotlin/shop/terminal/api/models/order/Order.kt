...
@NoAutoDetect
class Order @JsonCreator private constructor(
    ...
    class Builder internal constructor() {
        ...
        /** Zero-based index of the order for this user only. */
        fun index(index: JsonField<Long>) =
            apply {
                this.index = index
            }
    ...
    class Amount @JsonCreator private constructor(
        ...
        override fun toString() = "Amount{shipping=$shipping, subtotal=$subtotal, additionalProperties=$additionalProperties}"
    }
    ...
    class Item @JsonCreator private constructor(
        ...
        override fun toString() = "Item{id=$id, amount=$amount, quantity=$quantity, description=$description, productVariantId=$productVariantId, additionalProperties=$additionalProperties}"
    }
    ...
    class Shipping @JsonCreator private constructor(
        ...
        @JsonProperty("street1") @ExcludeMissing private val street1: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("province") @ExcludeMissing private val province: JsonField<String> = JsonMissing.of(),
        @JsonProperty("street2") @ExcludeMissing private val street2: JsonField<String> = JsonMissing.of(),
        @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
        ...
        @ExcludeMissing
        fun _street1(): JsonField<String> = street1
        ...
        @ExcludeMissing
        fun _street2(): JsonField<String> = street2
        ...
        class Builder internal constructor() {
            ...
            /** Street of the address. */
            fun street1(street1: JsonField<String>) =
                apply {
            ...
            /** Apartment, suite, etc. of the address. */
            fun street2(street2: JsonField<String>) =
                apply {
        ...
        override fun toString() = "Shipping{city=$city, country=$country, name=$name, street1=$street1, zip=$zip, phone=$phone, province=$province, street2=$street2, additionalProperties=$additionalProperties}"
    }
    ...
    class Tracking @JsonCreator private constructor(
        ...
        override fun toString() = "Tracking{number=$number, service=$service, url=$url, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() = "Order{id=$id, amount=$amount, items=$items, shipping=$shipping, tracking=$tracking, index=$index, additionalProperties=$additionalProperties}"
}
