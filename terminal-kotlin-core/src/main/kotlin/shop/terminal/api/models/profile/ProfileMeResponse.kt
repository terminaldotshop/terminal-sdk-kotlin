...
@NoAutoDetect
class ProfileMeResponse @JsonCreator private constructor(
    ...
    fun validate(): ProfileMeResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(profileMeResponse: ProfileMeResponse) =
            apply {
    ...
    override fun toString() = "ProfileMeResponse{data=$data, additionalProperties=$additionalProperties}"
}
