...
class CartRedeemGiftCardParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        override fun toString() = "Body{giftCardId=$giftCardId, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(cartRedeemGiftCardParams: CartRedeemGiftCardParams) =
            apply {
        ...
        fun giftCardId(giftCardId: String) =
            apply {
    ...
    override fun toString() = "CartRedeemGiftCardParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
