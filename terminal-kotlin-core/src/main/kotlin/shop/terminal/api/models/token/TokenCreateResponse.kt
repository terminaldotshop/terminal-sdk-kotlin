...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [TokenCreateResponse].
         *
        ...
        fun build(): TokenCreateResponse =
            TokenCreateResponse(checkRequired("data", data), additionalProperties.toMutableMap())
    }
    ...
    private constructor(
        ...
        internal fun validity(): Int =
            (if (id.asKnown() == null) 0 else 1) + (if (token.asKnown() == null) 0 else 1)
