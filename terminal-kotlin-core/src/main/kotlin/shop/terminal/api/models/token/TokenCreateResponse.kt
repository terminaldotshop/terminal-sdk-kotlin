...
@NoAutoDetect
class TokenCreateResponse @JsonCreator private constructor(
    ...
    fun validate(): TokenCreateResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(tokenCreateResponse: TokenCreateResponse) =
            apply {
    ...
    class Data @JsonCreator private constructor(
        ...
        override fun toString() = "Data{id=$id, token=$token, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() = "TokenCreateResponse{data=$data, additionalProperties=$additionalProperties}"
}
