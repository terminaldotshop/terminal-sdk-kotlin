...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [AppDeleteResponse].
         *
        ...
        fun build(): AppDeleteResponse =
            AppDeleteResponse(checkRequired("data", data), additionalProperties.toMutableMap())
    }
    ...
    override fun toString() =
        "AppDeleteResponse{data=$data, additionalProperties=$additionalProperties}"
}
