...
@NoAutoDetect
class AppDeleteResponse @JsonCreator private constructor(
    ...
    fun validate(): AppDeleteResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AppDeleteResponse].
         *
    ...
    /** A builder for [AppDeleteResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<Data>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(appDeleteResponse: AppDeleteResponse) =
            apply {
                data = appDeleteResponse.data
                additionalProperties = appDeleteResponse.additionalProperties.toMutableMap()
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AppDeleteResponse && data == other.data && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() = "AppDeleteResponse{data=$data, additionalProperties=$additionalProperties}"
}
