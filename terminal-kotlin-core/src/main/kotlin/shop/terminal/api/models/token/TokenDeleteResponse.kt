...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TokenDeleteResponse].
         *
    ...
    /** A builder for [TokenDeleteResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<Data>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(tokenDeleteResponse: TokenDeleteResponse) = apply {
            data = tokenDeleteResponse.data
            additionalProperties = tokenDeleteResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TokenDeleteResponse].
         *
         ...
         */
        fun build(): TokenDeleteResponse =
            TokenDeleteResponse(checkRequired("data", data), additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): TokenDeleteResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "TokenDeleteResponse{data=$data, additionalProperties=$additionalProperties}"
}
