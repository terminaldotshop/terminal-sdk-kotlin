...
@NoAutoDetect
class TokenDeleteResponse @JsonCreator private constructor(
    ...
    fun validate(): TokenDeleteResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(tokenDeleteResponse: TokenDeleteResponse) =
            apply {
    ...
    override fun toString() = "TokenDeleteResponse{data=$data, additionalProperties=$additionalProperties}"
}
