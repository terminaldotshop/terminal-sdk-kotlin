...
private constructor(
    ...
    companion object {
        ...
        fun none(): OrderGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        fun build(): OrderGetParams =
            OrderGetParams(id, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "OrderGetParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
