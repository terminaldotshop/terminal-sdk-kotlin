...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [CartConvertResponse].
         *
        ...
        fun build(): CartConvertResponse =
            CartConvertResponse(checkRequired("data", data), additionalProperties.toMutableMap())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CartConvertResponse &&
            data == other.data &&
