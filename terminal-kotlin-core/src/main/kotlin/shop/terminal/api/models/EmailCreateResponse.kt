...
@JsonDeserialize(builder = EmailCreateResponse.Builder::class)
@NoAutoDetect
...
private constructor(
    ...
    class Builder {
        ...
        internal fun from(emailCreateResponse: EmailCreateResponse) = apply {
            this.data = emailCreateResponse.data
            additionalProperties(emailCreateResponse.additionalProperties)
        }
        ...
        fun build(): EmailCreateResponse =
            EmailCreateResponse(data, additionalProperties.toImmutable())
    }
