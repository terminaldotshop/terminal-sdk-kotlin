...
@NoAutoDetect
class ViewInitResponse @JsonCreator private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(viewInitResponse: ViewInitResponse) =
            apply {
    ...
    class Data @JsonCreator private constructor(
        @JsonProperty("addresses") @ExcludeMissing private val addresses: JsonField<List<Address>> = JsonMissing.of(),
        @JsonProperty("apps") @ExcludeMissing private val apps: JsonField<List<App>> = JsonMissing.of(),
        @JsonProperty("cards") @ExcludeMissing private val cards: JsonField<List<Card>> = JsonMissing.of(),
        @JsonProperty("cart") @ExcludeMissing private val cart: JsonField<Cart> = JsonMissing.of(),
        @JsonProperty("orders") @ExcludeMissing private val orders: JsonField<List<Order>> = JsonMissing.of(),
        @JsonProperty("products") @ExcludeMissing private val products: JsonField<List<Product>> = JsonMissing.of(),
        @JsonProperty("profile") @ExcludeMissing private val profile: JsonField<Profile> = JsonMissing.of(),
        @JsonProperty("subscriptions") @ExcludeMissing private val subscriptions: JsonField<List<Subscription>> = JsonMissing.of(),
        @JsonProperty("tokens") @ExcludeMissing private val tokens: JsonField<List<Token>> = JsonMissing.of(),
        @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
        ...
        @JsonProperty("apps")
        @ExcludeMissing
        fun _apps(): JsonField<List<App>> = apps

        @JsonProperty("cards")
        @ExcludeMissing
        fun _cards(): JsonField<List<Card>> = cards

        /** The current Terminal shop user's cart. */
        @JsonProperty("cart")
        @ExcludeMissing
        fun _cart(): JsonField<Cart> = cart

        @JsonProperty("orders")
        @ExcludeMissing
        fun _orders(): JsonField<List<Order>> = orders
        ...
        @JsonProperty("tokens")
        @ExcludeMissing
        fun _tokens(): JsonField<List<Token>> = tokens
        ...
        class Builder internal constructor() {
            ...
            fun addresses(addresses: JsonField<List<Address>>) =
                apply {
            ...
            fun apps(apps: JsonField<List<App>>) =
                apply {
            ...
            fun addApp(app: App) =
                apply {
                    apps = (apps ?: JsonField.of(mutableListOf())).also {
                        checkKnown("apps", it).add(app)
                    }
                }

            fun cards(cards: List<Card>) = cards(JsonField.of(cards))

            fun cards(cards: JsonField<List<Card>>) =
                apply {
            ...
            fun addCard(card: Card) =
                apply {
                    cards = (cards ?: JsonField.of(mutableListOf())).also {
            ...
            fun orders(orders: JsonField<List<Order>>) =
                apply {
            ...
            fun addOrder(order: Order) =
                apply {
                    orders = (orders ?: JsonField.of(mutableListOf())).also {
            ...
            fun products(products: JsonField<List<Product>>) =
                apply {
            ...
            /** A Terminal shop user's profile. (We have users, btw.) */
            fun profile(profile: JsonField<Profile>) =
                apply {
            ...
            fun tokens(tokens: JsonField<List<Token>>) =
                apply {
        ...
        override fun toString() = "Data{addresses=$addresses, apps=$apps, cards=$cards, cart=$cart, orders=$orders, products=$products, profile=$profile, subscriptions=$subscriptions, tokens=$tokens, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() = "ViewInitResponse{data=$data, additionalProperties=$additionalProperties}"
}
