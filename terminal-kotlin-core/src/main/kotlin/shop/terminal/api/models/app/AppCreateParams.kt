...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [AppCreateParams].
         *
    ...
    private constructor(
        ...
        ) : this(name, redirectUri, mutableMapOf())
        ...
        internal fun validity(): Int =
            (if (name.asKnown() == null) 0 else 1) + (if (redirectUri.asKnown() == null) 0 else 1)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AppCreateParams &&
            body == other.body &&
