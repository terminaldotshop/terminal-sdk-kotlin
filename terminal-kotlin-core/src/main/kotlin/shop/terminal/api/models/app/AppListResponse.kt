...
private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<App>> = JsonMissing.of()
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [AppListResponse].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AppListResponse &&
            data == other.data &&
