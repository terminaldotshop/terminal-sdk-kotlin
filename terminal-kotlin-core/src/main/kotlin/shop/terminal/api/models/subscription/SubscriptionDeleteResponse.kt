...
@NoAutoDetect
class SubscriptionDeleteResponse @JsonCreator private constructor(
    ...
    fun validate(): SubscriptionDeleteResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(subscriptionDeleteResponse: SubscriptionDeleteResponse) =
            apply {
    ...
    override fun toString() = "SubscriptionDeleteResponse{data=$data, additionalProperties=$additionalProperties}"
}
