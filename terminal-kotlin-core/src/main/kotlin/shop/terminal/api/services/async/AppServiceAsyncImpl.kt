...
class AppServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : AppServiceAsync {

    private val withRawResponse: AppServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): AppServiceAsync.WithRawResponse = withRawResponse

    override suspend fun create(params: AppCreateParams, requestOptions: RequestOptions): AppCreateResponse =
        // post /app
        withRawResponse().create(params, requestOptions).parse()

    override suspend fun list(params: AppListParams, requestOptions: RequestOptions): AppListResponse =
        // get /app
        withRawResponse().list(params, requestOptions).parse()

    override suspend fun delete(params: AppDeleteParams, requestOptions: RequestOptions): AppDeleteResponse =
        // delete /app/{id}
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun create(params: AppCreateParams, requestOptions: RequestOptions): HttpResponseFor<AppCreateResponse> {
        ...
        override suspend fun list(params: AppListParams, requestOptions: RequestOptions): HttpResponseFor<AppListResponse> {
          val request = HttpRequest.builder()
        ...
        override suspend fun delete(params: AppDeleteParams, requestOptions: RequestOptions): HttpResponseFor<AppDeleteResponse> {
          val request = HttpRequest.builder()
        ...
        override suspend fun get(params: AppGetParams, requestOptions: RequestOptions): HttpResponseFor<AppGetResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("app", params.getPathParam(0))
            .build()
