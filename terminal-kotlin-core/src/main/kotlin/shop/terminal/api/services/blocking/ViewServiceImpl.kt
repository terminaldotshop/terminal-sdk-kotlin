...
class ViewServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : ViewService {

    private val withRawResponse: ViewService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun init(params: ViewInitParams, requestOptions: RequestOptions): HttpResponseFor<ViewInitResponse> {
