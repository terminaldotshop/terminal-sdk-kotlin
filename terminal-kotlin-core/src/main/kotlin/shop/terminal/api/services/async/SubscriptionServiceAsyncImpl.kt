...
class SubscriptionServiceAsyncImpl internal constructor(
    ...
    override suspend fun list(params: SubscriptionListParams, requestOptions: RequestOptions): SubscriptionListResponse =
        // get /subscription
        withRawResponse().list(params, requestOptions).parse()

    override suspend fun delete(params: SubscriptionDeleteParams, requestOptions: RequestOptions): SubscriptionDeleteResponse =
        // delete /subscription/{id}
        withRawResponse().delete(params, requestOptions).parse()

    override suspend fun get(params: SubscriptionGetParams, requestOptions: RequestOptions): SubscriptionGetResponse =
        // get /subscription/{id}
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun list(params: SubscriptionListParams, requestOptions: RequestOptions): HttpResponseFor<SubscriptionListResponse> {
          val request = HttpRequest.builder()
        ...
        override suspend fun delete(params: SubscriptionDeleteParams, requestOptions: RequestOptions): HttpResponseFor<SubscriptionDeleteResponse> {
          val request = HttpRequest.builder()
        ...
        override suspend fun get(params: SubscriptionGetParams, requestOptions: RequestOptions): HttpResponseFor<SubscriptionGetResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("subscription", params.getPathParam(0))
            .build()
