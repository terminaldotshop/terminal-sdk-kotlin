...
class ProfileServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : ProfileServiceAsync {

    private val withRawResponse: ProfileServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): ProfileServiceAsync.WithRawResponse = withRawResponse

    override suspend fun update(params: ProfileUpdateParams, requestOptions: RequestOptions): ProfileUpdateResponse =
        // put /profile
        withRawResponse().update(params, requestOptions).parse()

    override suspend fun me(params: ProfileMeParams, requestOptions: RequestOptions): ProfileMeResponse =
        // get /profile
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun update(params: ProfileUpdateParams, requestOptions: RequestOptions): HttpResponseFor<ProfileUpdateResponse> {
        ...
        override suspend fun me(params: ProfileMeParams, requestOptions: RequestOptions): HttpResponseFor<ProfileMeResponse> {
          val request = HttpRequest.builder()
