...
class CartServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : CartService {

    private val withRawResponse: CartService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): CartService.WithRawResponse = withRawResponse

    override fun convert(params: CartConvertParams, requestOptions: RequestOptions): CartConvertResponse =
        // post /cart/convert
    ...
    override fun redeemGiftCard(params: CartRedeemGiftCardParams, requestOptions: RequestOptions): CartRedeemGiftCardResponse =
        // put /cart/gift-card
        withRawResponse().redeemGiftCard(params, requestOptions).parse()

    override fun removeGiftCard(params: CartRemoveGiftCardParams, requestOptions: RequestOptions): CartRemoveGiftCardResponse =
        // delete /cart/gift-card
        withRawResponse().removeGiftCard(params, requestOptions).parse()

    override fun setAddress(params: CartSetAddressParams, requestOptions: RequestOptions): CartSetAddressResponse =
        // put /cart/address
        withRawResponse().setAddress(params, requestOptions).parse()

    override fun setCard(params: CartSetCardParams, requestOptions: RequestOptions): CartSetCardResponse =
        // put /cart/card
        withRawResponse().setCard(params, requestOptions).parse()

    override fun setItem(params: CartSetItemParams, requestOptions: RequestOptions): CartSetItemResponse =
        // put /cart/item
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun convert(params: CartConvertParams, requestOptions: RequestOptions): HttpResponseFor<CartConvertResponse> {
        ...
        override fun get(params: CartGetParams, requestOptions: RequestOptions): HttpResponseFor<CartGetResponse> {
          val request = HttpRequest.builder()
        ...
        override fun redeemGiftCard(params: CartRedeemGiftCardParams, requestOptions: RequestOptions): HttpResponseFor<CartRedeemGiftCardResponse> {
          val request = HttpRequest.builder()
        ...
        override fun removeGiftCard(params: CartRemoveGiftCardParams, requestOptions: RequestOptions): HttpResponseFor<CartRemoveGiftCardResponse> {
          val request = HttpRequest.builder()
        ...
        override fun setAddress(params: CartSetAddressParams, requestOptions: RequestOptions): HttpResponseFor<CartSetAddressResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.PUT)
        ...
        override fun setCard(params: CartSetCardParams, requestOptions: RequestOptions): HttpResponseFor<CartSetCardResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.PUT)
        ...
        override fun setItem(params: CartSetItemParams, requestOptions: RequestOptions): HttpResponseFor<CartSetItemResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.PUT)
