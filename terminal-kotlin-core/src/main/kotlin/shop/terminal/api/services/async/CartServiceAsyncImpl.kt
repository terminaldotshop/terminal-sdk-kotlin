...
class CartServiceAsyncImpl internal constructor(
    ...
    override suspend fun convert(params: CartConvertParams, requestOptions: RequestOptions): CartConvertResponse =
        // post /cart/convert
        withRawResponse().convert(params, requestOptions).parse()

    override suspend fun get(params: CartGetParams, requestOptions: RequestOptions): CartGetResponse =
        // get /cart
        withRawResponse().get(params, requestOptions).parse()

    override suspend fun redeemGiftCard(params: CartRedeemGiftCardParams, requestOptions: RequestOptions): CartRedeemGiftCardResponse =
        // put /cart/gift-card
        withRawResponse().redeemGiftCard(params, requestOptions).parse()

    override suspend fun removeGiftCard(params: CartRemoveGiftCardParams, requestOptions: RequestOptions): CartRemoveGiftCardResponse =
        // delete /cart/gift-card
        withRawResponse().removeGiftCard(params, requestOptions).parse()

    override suspend fun setAddress(params: CartSetAddressParams, requestOptions: RequestOptions): CartSetAddressResponse =
        // put /cart/address
        withRawResponse().setAddress(params, requestOptions).parse()

    override suspend fun setCard(params: CartSetCardParams, requestOptions: RequestOptions): CartSetCardResponse =
        // put /cart/card
        withRawResponse().setCard(params, requestOptions).parse()

    override suspend fun setItem(params: CartSetItemParams, requestOptions: RequestOptions): CartSetItemResponse =
        // put /cart/item
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun convert(params: CartConvertParams, requestOptions: RequestOptions): HttpResponseFor<CartConvertResponse> {
        ...
        override suspend fun get(params: CartGetParams, requestOptions: RequestOptions): HttpResponseFor<CartGetResponse> {
          val request = HttpRequest.builder()
        ...
        override suspend fun redeemGiftCard(params: CartRedeemGiftCardParams, requestOptions: RequestOptions): HttpResponseFor<CartRedeemGiftCardResponse> {
          val request = HttpRequest.builder()
        ...
        override suspend fun removeGiftCard(params: CartRemoveGiftCardParams, requestOptions: RequestOptions): HttpResponseFor<CartRemoveGiftCardResponse> {
          val request = HttpRequest.builder()
        ...
        override suspend fun setAddress(params: CartSetAddressParams, requestOptions: RequestOptions): HttpResponseFor<CartSetAddressResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.PUT)
        ...
        override suspend fun setCard(params: CartSetCardParams, requestOptions: RequestOptions): HttpResponseFor<CartSetCardResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.PUT)
        ...
        override suspend fun setItem(params: CartSetItemParams, requestOptions: RequestOptions): HttpResponseFor<CartSetItemResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.PUT)
