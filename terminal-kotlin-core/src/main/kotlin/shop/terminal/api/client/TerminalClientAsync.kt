...
/**
 * A client for interacting with the Terminal REST API asynchronously. You can also
...
interface TerminalClientAsync {
    ...
    /**
     * A view of [TerminalClientAsync] that provides access to raw HTTP responses for
     * each method.
     */
