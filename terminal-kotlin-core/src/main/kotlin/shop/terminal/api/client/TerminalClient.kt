...
/**
 * A client for interacting with the Terminal REST API synchronously. You can also
...
interface TerminalClient {
    ...
    /**
     * A view of [TerminalClient] that provides access to raw HTTP responses for each
     * method.
     */
