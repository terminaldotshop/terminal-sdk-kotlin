...
class ViewInitResponseTest {
    ...
    fun createViewInitResponse() {
      val viewInitResponse = ViewInitResponse.builder()
          .data(ViewInitResponse.Data.builder()
              ...
              .profile(Profile.builder()
                  .user(Profile.User.builder()
                      ...
                      .build())
                  .build())
              .addSubscription(Subscription.builder()
      ...
      assertThat(viewInitResponse.data()).isEqualTo(ViewInitResponse.Data.builder()
          .addAddress(Address.builder()
              .id("shp_XXXXXXXXXXXXXXXXXXXXXXXXX")
              .city("Anytown")
              .country("US")
