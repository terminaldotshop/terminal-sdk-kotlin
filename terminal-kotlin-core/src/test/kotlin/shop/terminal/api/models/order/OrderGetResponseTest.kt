...
internal class OrderGetResponseTest {
    ...
    fun roundtrip() {
        ...
        val roundtrippedOrderGetResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(orderGetResponse),
                jacksonTypeRef<OrderGetResponse>(),
            )

        assertThat(roundtrippedOrderGetResponse).isEqualTo(orderGetResponse)
    }
}
