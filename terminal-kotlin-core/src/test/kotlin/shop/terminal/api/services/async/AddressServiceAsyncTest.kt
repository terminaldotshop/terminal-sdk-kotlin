...
class AddressServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val address = addressServiceAsync.create(AddressCreateParams.builder()
          .city("Anytown")
          .country("US")
          .name("John Doe")
          .street1("123 Main St")
    ...
    suspend fun delete() {
      ...
      val address = addressServiceAsync.delete(AddressDeleteParams.builder()
    ...
    suspend fun get() {
      ...
      val address = addressServiceAsync.get(AddressGetParams.builder()
          .id("shp_XXXXXXXXXXXXXXXXXXXXXXXXX")
          .build())
