...
class SubscriptionServiceAsyncTest {
    ...
    suspend fun delete() {
      ...
      val subscription = subscriptionServiceAsync.delete(SubscriptionDeleteParams.builder()
          .id("sub_XXXXXXXXXXXXXXXXXXXXXXXXX")
          .build())
    ...
    suspend fun get() {
      ...
      val subscription = subscriptionServiceAsync.get(SubscriptionGetParams.builder()
          .id("sub_XXXXXXXXXXXXXXXXXXXXXXXXX")
          .build())
