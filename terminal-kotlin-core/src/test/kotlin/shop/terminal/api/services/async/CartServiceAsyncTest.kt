...
class CartServiceAsyncTest {
    ...
    suspend fun convert() {
      ...
      val response = cartServiceAsync.convert(CartConvertParams.builder()
    ...
    suspend fun redeemGiftCard() {
      ...
      val response = cartServiceAsync.redeemGiftCard(CartRedeemGiftCardParams.builder()
    ...
    suspend fun removeGiftCard() {
      ...
      val response = cartServiceAsync.removeGiftCard()
    ...
    suspend fun setAddress() {
      ...
      val response = cartServiceAsync.setAddress(CartSetAddressParams.builder()
    ...
    suspend fun setCard() {
      ...
      val response = cartServiceAsync.setCard(CartSetCardParams.builder()
    ...
    suspend fun setItem() {
      ...
      val response = cartServiceAsync.setItem(CartSetItemParams.builder()
